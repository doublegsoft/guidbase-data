...
${""?left_pad(indent)}    <text class="tile-time">
    <#if guidbase.has_child_widget(widget, "start_time")>${""?left_pad(indent)}<text>{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "start_time"))} }}</text></#if>
    ...
    <#if guidbase.has_child_widget(widget, "end_time")>${""?left_pad(indent)}<text>{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "end_time"))} }}</text></#if>
${""?left_pad(indent)}    </text>
  </#if>
  <#if guidbase.has_child_widget(widget, "status")>
${""?left_pad(indent)}    <text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text>
  </#if>
...
${""?left_pad(indent)}    <view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view>
    </#if>
    <#if guidbase.has_child_widget(widget, "secondary")>
${""?left_pad(indent)}    <view class="tile-secondary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "secondary"))} }}</view>
    </#if>
${""?left_pad(indent)}  </view>
  </#if>
  <#if guidbase.has_child_widget(widget, "avatars")>
${""?left_pad(indent)}  <view class="tile-footer">
${""?left_pad(indent)}    <view class="tile-avatars"><image wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatars"))} }}" wx:for-item="av" wx:for-index="idx" wx:key="idx" src="{{ av }}" class="tile-avatar-img"></image></view>
${""?left_pad(indent)}  </view>
  </#if>
${""?left_pad(indent)}</view>
</#macro>
...
${""?left_pad(indent)}      <image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "image"))} }}"></image>
${""?left_pad(indent)}    </view>
    <#if guidbase.has_child_widget(widget, "tags")>
${""?left_pad(indent)}    <view class="tile-image-tags">
${""?left_pad(indent)}      <text><text wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tags"))} }}" wx:for-item="tag" wx:for-index="idx" wx:key="idx" class="tile-tag">{{ tag }}</text></text>
${""?left_pad(indent)}    </view>
    </#if>
${""?left_pad(indent)}  </view>
  </#if>
...
${""?left_pad(indent)}    <view class="tile-tertiary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tertiary"))} }}</view>
    </#if>
${""?left_pad(indent)}  </view>
  </#if>
${""?left_pad(indent)}</view>
...
${""?left_pad(indent)}      <image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatar"))} }}"></image>
${""?left_pad(indent)}    </view>
  </#if>
${""?left_pad(indent)}    <view class="tile-body">
    <#if guidbase.has_child_widget(widget, "primary")>
...
${""?left_pad(indent)}  <view class="tile-row tile-header">
  <#if guidbase.has_child_widget(widget, "tags")>
${""?left_pad(indent)}    <text class="tile-tags"><text wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tags"))} }}" wx:for-item="tag" wx:for-index="idx" wx:key="idx" class="tile-tag">{{ tag }}</text></text>
  </#if>
  <#if guidbase.has_child_widget(widget, "status")>
${""?left_pad(indent)}    <text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text>
  </#if>
...
${""?left_pad(indent)}    <text class="tile-end-time">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "end_time"))} }}</text>
  </#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}</view>
</#macro>
...
${""?left_pad(indent)}    <image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "background"))} }}"></image>
${""?left_pad(indent)}  </view>
  </#if>
${""?left_pad(indent)}  <view class="tile-overlay">
  <#if guidbase.has_child_widget(widget, "tags")>
${""?left_pad(indent)}    <view class="tile-tags"><text wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tags"))} }}" wx:for-item="tag" wx:for-index="idx" wx:key="idx" class="tile-tag">{{ tag }}</text></view>
  </#if>
  <#if guidbase.has_child_widget(widget, "primary")>
${""?left_pad(indent)}    <view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view>
  </#if>
...
${""?left_pad(indent)}    <text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text>
  ...
  <#if guidbase.has_child_widget(widget, "primary")>
${""?left_pad(indent)}    <text class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</text>
  </#if>
  <#if guidbase.has_child_widget(widget, "secondary")>
${""?left_pad(indent)}    <text class="tile-secondary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "secondary"))} }}</text>
  </#if>
  <#if guidbase.has_child_widget(widget, "start_time")>
${""?left_pad(indent)}    <text class="tile-start-time">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "start_time"))} }}</text>
  </#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}</view>
</#macro>
...
${""?left_pad(indent)}    <view class="tile-time">
    <#if guidbase.has_child_widget(widget, "start_time")><text>{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "start_time"))} }}</text></#if>
    <#if guidbase.has_child_widget(widget, "start_time") && guidbase.has_child_widget(widget, "end_time")> ~ </#if>
    <#if guidbase.has_child_widget(widget, "end_time")><text>{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "end_time"))} }}</text></#if>
${""?left_pad(indent)}    </view>
    </#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}</view>
...
${""?left_pad(indent)}      <view class="tile-row">
    <#if guidbase.has_child_widget(widget, "tertiary")>
${""?left_pad(indent)}        <text class="tile-tertiary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tertiary"))} }}</text>
    </#if>
    <#if guidbase.has_child_widget(widget, "status")>
${""?left_pad(indent)}        <text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text>
    </#if>
...
${""?left_pad(indent)}    <view class="tile-secondary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "secondary"))} }}</view>
    ...
    <#if guidbase.has_child_widget(widget, "start_time")>
${""?left_pad(indent)}    <view class="tile-start-time">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "start_time"))} }}</view>
    </#if>
    <#if guidbase.has_child_widget(widget, "end_time")>
${""?left_pad(indent)}    <view class="tile-end-time">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "end_time"))} }}</view>
    </#if>
    <#if guidbase.has_child_widget(widget, "avatars")>
${""?left_pad(indent)}    <view class="tile-avatars"><image wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatars"))} }}" wx:for-item="av" wx:for-index="idx" wx:key="idx" src="{{ av }}" class="tile-avatar-img"></image></view>
    </#if>
...
${""?left_pad(indent)}    <view class="tile-avatar">
${""?left_pad(indent)}      <image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatar2"))} }}"></image>
${""?left_pad(indent)}    </view>
  </#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  <view class="tile-row tile-footer">
...
${""?left_pad(indent)}        <text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text>
    ...
    <#if guidbase.has_child_widget(widget, "avatars")>
${""?left_pad(indent)}        <text class="tile-avatars"><image wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatars"))} }}" wx:for-item="av" wx:for-index="idx" wx:key="idx" src="{{ av }}" class="tile-avatar-img"></image></text>
    </#if>
${""?left_pad(indent)}      </view>
${""?left_pad(indent)}    </view>
${""?left_pad(indent)}  </view>
...
${""?left_pad(indent)}<view class="tile tile-tall-sidebar">
  <#if guidbase.has_child_widget(widget, "status")>
${""?left_pad(indent)}  <view class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</view>
  </#if>
  <#if guidbase.has_child_widget(widget, "image")>
${""?left_pad(indent)}  <view class="tile-image-wrap">
${""?left_pad(indent)}    <view class="tile-image">
...
${""?left_pad(indent)}  </view>
  <#if guidbase.has_child_widget(widget, "primary")>
${""?left_pad(indent)}  <view class="tile-primary tile-right">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view>
  </#if>
  <#if guidbase.has_child_widget(widget, "tags")>
${""?left_pad(indent)}  <view class="tile-tags tile-right"><text wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tags"))} }}" wx:for-item="tag" wx:for-index="idx" wx:key="idx" class="tile-tag">{{ tag }}</text></view>
  </#if>
${""?left_pad(indent)}</view>
</#macro>
...
${""?left_pad(indent)}  <view class="tile-overlay">
  <#if guidbase.has_child_widget(widget, "start_time")>
${""?left_pad(indent)}    <view class="tile-start-time tile-right">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "start_time"))} }}</view>
  </#if>
  <#if guidbase.has_child_widget(widget, "primary")>
${""?left_pad(indent)}    <view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view>
  </#if>
...
+-----------------------------------------------+
-->
<#macro print_tile_kpi_dashboard widget indent=0>
${""?left_pad(indent)}<view class="tile tile-kpi-dashboard layout-timeline">
${""?left_pad(indent)}  <view class="tile-row tile-header">
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "start_time")><text class="tile-start-time">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "start_time"))} }}</text></#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "status")><text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text></#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  <view class="tile-body">
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "primary")><view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view></#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "secondary")><view class="tile-secondary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "secondary"))} }}</view></#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  <#if guidbase.has_child_widget(widget, "tags")>
${""?left_pad(indent)}  <view class="tile-footer">
${""?left_pad(indent)}    <view class="tile-tags"><text wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tags"))} }}" wx:for-item="tag" wx:key="*this" class="tile-tag">{{ tag }}</text></view>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  </#if>
${""?left_pad(indent)}</view>
</#macro>
...
+-----------------------------------------------+
-->
<#macro print_tile_stat_comparison widget indent=0>
...
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "primary")><view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view></#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "secondary")><view class="tile-secondary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "secondary"))} }}</view></#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "tertiary")><view class="tile-tertiary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tertiary"))} }}</view></#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  <#if guidbase.has_child_widget(widget, "avatars")>
${""?left_pad(indent)}  <view class="tile-footer">
${""?left_pad(indent)}    <view class="tile-avatars"><image wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatars"))} }}" wx:for-item="av" wx:key="*this" src="{{ av }}" class="tile-avatar-img"></image></view>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  </#if>
${""?left_pad(indent)}</view>
</#macro>
...
+-----------------------------------------------+
-->
<#macro print_tile_progress_meter widget indent=0>
${""?left_pad(indent)}<view class="tile tile-progress-meter layout-timeline">
${""?left_pad(indent)}  <view class="tile-row tile-header">
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "start_time")><text class="tile-start-time">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "start_time"))} }}</text></#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "end_time")><text class="tile-end-time">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "end_time"))} }}</text></#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  <view class="tile-body">
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "primary")><view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view></#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "status")><view class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</view></#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  <#if guidbase.has_child_widget(widget, "tags")>
${""?left_pad(indent)}  <view class="tile-footer">
${""?left_pad(indent)}    <view class="tile-tags"><text wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "tags"))} }}" wx:for-item="tag" wx:key="*this" class="tile-tag">{{ tag }}</text></view>
...
+-----------------------------------------------+
-->
<#macro print_tile_ranking_row widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_leaderboard widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_price_plan widget indent=0>
${""?left_pad(indent)}<view class="tile tile-price-plan layout-media">
${""?left_pad(indent)}  <#if guidbase.has_child_widget(widget, "image")>
${""?left_pad(indent)}  <view class="tile-image"><image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "image"))} }}"></image></view>
${""?left_pad(indent)}  </#if>
${""?left_pad(indent)}  <view class="tile-body">
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "primary")><view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view></#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "secondary")><view class="tile-secondary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "secondary"))} }}</view></#if>
...
+-----------------------------------------------+
-->
<#macro print_tile_checkout_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_order_tracking widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_shipping_event widget indent=0>
${""?left_pad(indent)}<view class="tile tile-shipping-event layout-timeline">
${""?left_pad(indent)}  <view class="tile-row">
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "avatar")><view class="tile-avatar"><image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatar"))} }}"></image></view></#if>
${""?left_pad(indent)}    <view class="tile-body">
${""?left_pad(indent)}      <#if guidbase.has_child_widget(widget, "primary")><view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view></#if>
${""?left_pad(indent)}      <#if guidbase.has_child_widget(widget, "secondary")><view class="tile-secondary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "secondary"))} }}</view></#if>
${""?left_pad(indent)}    </view>
...
+-----------------------------------------------+
-->
<#macro print_tile_invoice_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_payment_method widget indent=0>
...
+===============================================+
-->
<#macro print_tile_account_balance widget indent=0>
...
${""?left_pad(indent)}  <view class="tile-background"><image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "background"))} }}"></image></view>
${""?left_pad(indent)}  </#if>
${""?left_pad(indent)}  <view class="tile-overlay">
${""?left_pad(indent)}    <view class="tile-row tile-header">
${""?left_pad(indent)}      <#if guidbase.has_child_widget(widget, "status")><text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text></#if>
...
+===============================================+
-->
<#macro print_tile_wallet_card widget indent=0>
...
+===============================================+
-->
<#macro print_tile_coupon_card widget indent=0>
...
${""?left_pad(indent)}    </#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "primary")><view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view></#if>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "end_time")><view class="tile-end-time">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "end_time"))} }}</view></#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}</view>
</#macro>
...
+-----------------------------------------------+
-->
<#macro print_tile_deal_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_property_listing widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_travel_destination widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_flight_segment widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_hotel_booking widget indent=0>
...
${""?left_pad(indent)}  <view class="tile-footer">
${""?left_pad(indent)}    <text class="tile-time">
${""?left_pad(indent)}      <#if guidbase.has_child_widget(widget, "start_time")><text>{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "start_time"))} }}</text></#if>
${""?left_pad(indent)}      <#if guidbase.has_child_widget(widget, "start_time") && guidbase.has_child_widget(widget, "end_time")><text> - </text></#if>
${""?left_pad(indent)}      <#if guidbase.has_child_widget(widget, "end_time")><text>{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "end_time"))} }}</text></#if>
${""?left_pad(indent)}    </text>
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "status")><text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text></#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}</view>
...
+-----------------------------------------------+
-->
<#macro print_tile_restaurant_reservation widget indent=0>
...
+===============================================+
-->
<#macro print_tile_event_ticket widget indent=0>
...
+===============================================+
-->
<#macro print_tile_speaker_profile widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_course_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_lesson_progress widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_quiz_result widget indent=0>
...
+===============================================+
-->
<#macro print_tile_certificate_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_article_quote widget indent=0>
...
${""?left_pad(indent)}  <view class="tile-footer">
${""?left_pad(indent)}    <view class="tile-avatar"><image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatar"))} }}"></image></view>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  </#if>
${""?left_pad(indent)}</view>
</#macro>
...
+-----------------------------------------------+
-->
<#macro print_tile_comment_thread widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_reply_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_reaction_summary widget indent=0>
${""?left_pad(indent)}<view class="tile tile-reaction-summary layout-profile">
${""?left_pad(indent)}  <#if guidbase.has_child_widget(widget, "avatars")>
${""?left_pad(indent)}  <view class="tile-avatars">
${""?left_pad(indent)}    <image wx:for="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "avatars"))} }}" wx:for-item="av" wx:key="*this" src="{{ av }}" class="tile-avatar-img"></image>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  </#if>
...
+-----------------------------------------------+
-->
<#macro print_tile_notification_group widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_inbox_thread widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_email_preview widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_calendar_agenda widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_calendar_month_event widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_date_range_picker widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_milestone_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_roadmap_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_sprint_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_kanban_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_kanban_swimlane widget indent=0>
...
+===============================================+
-->
<#macro print_tile_project_health widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_team_presence widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_org_chart_node widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_contact_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_user_activity widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_access_log widget indent=0>
...
+===============================================+
-->
<#macro print_tile_security_alert widget indent=0>
...
+===============================================+
-->
<#macro print_tile_system_health widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_service_status widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_api_endpoint widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_release_note widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_version_badge widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_deployment_event widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_commit_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_build_result widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_file_preview widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_folder_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_media_collection widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_playlist_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_podcast_episode widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_gallery_mosaic widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_message_compose widget indent=0>
...
+===============================================+
-->
<#macro print_tile_chat_room_header widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_chat_attachment widget indent=0>
...
${""?left_pad(indent)}    <#if guidbase.has_child_widget(widget, "primary")><view class="tile-primary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "primary"))} }}</view></#if>
${""?left_pad(indent)}    <view class="tile-row">
${""?left_pad(indent)}      <#if guidbase.has_child_widget(widget, "secondary")><text class="tile-secondary">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "secondary"))} }}</text></#if>
${""?left_pad(indent)}      <#if guidbase.has_child_widget(widget, "status")><text class="tile-status">{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "status"))} }}</text></#if>
${""?left_pad(indent)}    </view>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}</view>
...
+-----------------------------------------------+
-->
<#macro print_tile_voice_message widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_call_history widget indent=0>
...
+===============================================+
-->
<#macro print_tile_video_call widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_contact_merge widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_address_book_group widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_favorite_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_saved_search widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_filter_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_sort_option widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_search_result widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_search_suggestion widget indent=0>
...
+===============================================+
-->
<#macro print_tile_empty_state_panel widget indent=0>
...
+===============================================+
-->
<#macro print_tile_error_state_panel widget indent=0>
...
+===============================================+
-->
<#macro print_tile_maintenance_notice widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_feature_flag widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_experiment_variant widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_ab_test_result widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_analytics_event widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_funnel_step widget indent=0>
...
+===============================================+
-->
<#macro print_tile_conversion_metric widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_chart_summary widget indent=0>
...
+===============================================+
-->
<#macro print_tile_report_header widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_report_row widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_data_source widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_dataset_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_query_history widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_export_job widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_import_job widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_sync_status widget indent=0>
...
+===============================================+
-->
<#macro print_tile_backup_snapshot widget indent=0>
...
+===============================================+
-->
<#macro print_tile_restore_point widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_storage_usage widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_quota_meter widget indent=0>
...
+===============================================+
-->
<#macro print_tile_license_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_subscription_plan widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_billing_cycle widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_tax_invoice widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_refund_case widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_support_ticket widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_support_agent widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_faq_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_knowledge_article widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_documentation_section widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_release_channel widget indent=0>
...
+===============================================+
-->
<#macro print_tile_roadmap_milestone widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_feedback_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_survey_question widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_survey_response widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_rating_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_review_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_moderation_case widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_content_flag widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_approval_request widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_approval_step widget indent=0>
...
+===============================================+
-->
<#macro print_tile_signature_request widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_document_version widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_document_collaborator widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_folder_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_permission_rule widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_role_assignment widget indent=0>
...
+===============================================+
-->
<#macro print_tile_audit_event_detail widget indent=0>
...
+===============================================+
-->
<#macro print_tile_incident_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_incident_timeline widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_on_call_shift widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_escalation_rule widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_runbook_step widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_monitor_check widget indent=0>
...
+===============================================+
-->
<#macro print_tile_alert_group widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_log_entry widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_trace_span widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_request_detail widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_server_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_container_card widget indent=0>
...
+===============================================+
-->
<#macro print_tile_cloud_region widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_integration_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_webhook_event widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_automation_rule widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_workflow_run widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_queue_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_job_detail widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_schedule_rule widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_recurring_task widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_approval_inbox widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_draft_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_publish_item widget indent=0>
...
+===============================================+
-->
<#macro print_tile_campaign_card widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_audience_segment widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_channel_summary widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_social_account widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_post_scheduler widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_content_calendar widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_brand_asset widget indent=0>
...
+===============================================+
-->
<#macro print_tile_theme_preview widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_component_variant widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_design_token widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_ui_pattern widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_prototype_screen widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_handoff_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_accessibility_check widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_translation_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_localization_status widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_language_pack widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_release_calendar widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_change_request widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_risk_register widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_dependency_item widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_decision_log widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_meeting_notes widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_action_item widget indent=0>
...
+===============================================+
-->
<#macro print_tile_okr_objective widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_key_result widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_goal_progress widget indent=0>
...
+===============================================+
-->
<#macro print_tile_personal_dashboard widget indent=0>
...
+-----------------------------------------------+
-->
<#macro print_tile_quick_action widget indent=0>
...
${""?left_pad(indent)}      <image src="{{ row.${guidbase.name_widget_variable(guidbase.get_child_from_tile(widget, "icon"))} }}"></image>
${""?left_pad(indent)}    </view>
${""?left_pad(indent)}    </#if>
${""?left_pad(indent)}  </view>
${""?left_pad(indent)}  <view class="tile-body">
