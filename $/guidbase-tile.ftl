...
<@tile.print_tile_kpi_dashboard widget=widget indent=indent />
  <#elseif tilename == "stat_comparison">
<@tile.print_tile_stat_comparison widget=widget indent=indent />
  <#elseif tilename == "progress_meter">
<@tile.print_tile_progress_meter widget=widget indent=indent />
  <#elseif tilename == "ranking_row">
<@tile.print_tile_ranking_row widget=widget indent=indent />
  <#elseif tilename == "leaderboard">
<@tile.print_tile_leaderboard widget=widget indent=indent />
  <#elseif tilename == "price_plan">
<@tile.print_tile_price_plan widget=widget indent=indent />
  <#elseif tilename == "checkout_summary">
<@tile.print_tile_checkout_summary widget=widget indent=indent />
  <#elseif tilename == "order_tracking">
<@tile.print_tile_order_tracking widget=widget indent=indent />
  <#elseif tilename == "shipping_event">
<@tile.print_tile_shipping_event widget=widget indent=indent />
  <#elseif tilename == "invoice_summary">
<@tile.print_tile_invoice_summary widget=widget indent=indent />
  <#elseif tilename == "payment_method">
<@tile.print_tile_payment_method widget=widget indent=indent />
  <#elseif tilename == "account_balance">
<@tile.print_tile_account_balance widget=widget indent=indent />
  <#elseif tilename == "wallet_card">
<@tile.print_tile_wallet_card widget=widget indent=indent />
  <#elseif tilename == "coupon_card">
<@tile.print_tile_coupon_card widget=widget indent=indent />
  <#elseif tilename == "deal_card">
<@tile.print_tile_deal_card widget=widget indent=indent />
  <#elseif tilename == "property_listing">
<@tile.print_tile_property_listing widget=widget indent=indent />
  <#elseif tilename == "travel_destination">
<@tile.print_tile_travel_destination widget=widget indent=indent />
  <#elseif tilename == "flight_segment">
<@tile.print_tile_flight_segment widget=widget indent=indent />
  <#elseif tilename == "hotel_booking">
<@tile.print_tile_hotel_booking widget=widget indent=indent />
  <#elseif tilename == "restaurant_reservation">
<@tile.print_tile_restaurant_reservation widget=widget indent=indent />
  <#elseif tilename == "event_ticket">
<@tile.print_tile_event_ticket widget=widget indent=indent />
  <#elseif tilename == "speaker_profile">
<@tile.print_tile_speaker_profile widget=widget indent=indent />
  <#elseif tilename == "course_card">
<@tile.print_tile_course_card widget=widget indent=indent />
  <#elseif tilename == "lesson_progress">
<@tile.print_tile_lesson_progress widget=widget indent=indent />
  <#elseif tilename == "quiz_result">
<@tile.print_tile_quiz_result widget=widget indent=indent />
  <#elseif tilename == "certificate_card">
<@tile.print_tile_certificate_card widget=widget indent=indent />
  <#elseif tilename == "article_quote">
<@tile.print_tile_article_quote widget=widget indent=indent />
  <#elseif tilename == "comment_thread">
<@tile.print_tile_comment_thread widget=widget indent=indent />
  <#elseif tilename == "reply_item">
<@tile.print_tile_reply_item widget=widget indent=indent />
  <#elseif tilename == "reaction_summary">
<@tile.print_tile_reaction_summary widget=widget indent=indent />
  <#elseif tilename == "notification_group">
<@tile.print_tile_notification_group widget=widget indent=indent />
  <#elseif tilename == "inbox_thread">
<@tile.print_tile_inbox_thread widget=widget indent=indent />
  <#elseif tilename == "email_preview">
<@tile.print_tile_email_preview widget=widget indent=indent />
  <#elseif tilename == "calendar_agenda">
<@tile.print_tile_calendar_agenda widget=widget indent=indent />
  <#elseif tilename == "calendar_month_event">
<@tile.print_tile_calendar_month_event widget=widget indent=indent />
  <#elseif tilename == "date_range_picker">
<@tile.print_tile_date_range_picker widget=widget indent=indent />
  <#elseif tilename == "milestone_card">
<@tile.print_tile_milestone_card widget=widget indent=indent />
  <#elseif tilename == "roadmap_item">
<@tile.print_tile_roadmap_item widget=widget indent=indent />
  <#elseif tilename == "sprint_summary">
<@tile.print_tile_sprint_summary widget=widget indent=indent />
  <#elseif tilename == "kanban_card">
<@tile.print_tile_kanban_card widget=widget indent=indent />
  <#elseif tilename == "kanban_swimlane">
<@tile.print_tile_kanban_swimlane widget=widget indent=indent />
  <#elseif tilename == "project_health">
<@tile.print_tile_project_health widget=widget indent=indent />
  <#elseif tilename == "team_presence">
<@tile.print_tile_team_presence widget=widget indent=indent />
  <#elseif tilename == "org_chart_node">
<@tile.print_tile_org_chart_node widget=widget indent=indent />
  <#elseif tilename == "contact_card">
<@tile.print_tile_contact_card widget=widget indent=indent />
  <#elseif tilename == "user_activity">
<@tile.print_tile_user_activity widget=widget indent=indent />
  <#elseif tilename == "access_log">
<@tile.print_tile_access_log widget=widget indent=indent />
  <#elseif tilename == "security_alert">
<@tile.print_tile_security_alert widget=widget indent=indent />
  <#elseif tilename == "system_health">
<@tile.print_tile_system_health widget=widget indent=indent />
  <#elseif tilename == "service_status">
<@tile.print_tile_service_status widget=widget indent=indent />
  <#elseif tilename == "api_endpoint">
<@tile.print_tile_api_endpoint widget=widget indent=indent />
  <#elseif tilename == "release_note">
<@tile.print_tile_release_note widget=widget indent=indent />
  <#elseif tilename == "version_badge">
<@tile.print_tile_version_badge widget=widget indent=indent />
  <#elseif tilename == "deployment_event">
<@tile.print_tile_deployment_event widget=widget indent=indent />
  <#elseif tilename == "commit_item">
<@tile.print_tile_commit_item widget=widget indent=indent />
  <#elseif tilename == "build_result">
<@tile.print_tile_build_result widget=widget indent=indent />
  <#elseif tilename == "file_preview">
<@tile.print_tile_file_preview widget=widget indent=indent />
  <#elseif tilename == "folder_summary">
<@tile.print_tile_folder_summary widget=widget indent=indent />
  <#elseif tilename == "media_collection">
<@tile.print_tile_media_collection widget=widget indent=indent />
  <#elseif tilename == "playlist_item">
<@tile.print_tile_playlist_item widget=widget indent=indent />
  <#elseif tilename == "podcast_episode">
<@tile.print_tile_podcast_episode widget=widget indent=indent />
  <#elseif tilename == "gallery_mosaic">
<@tile.print_tile_gallery_mosaic widget=widget indent=indent />
  <#elseif tilename == "message_compose">
<@tile.print_tile_message_compose widget=widget indent=indent />
  <#elseif tilename == "chat_room_header">
<@tile.print_tile_chat_room_header widget=widget indent=indent />
  <#elseif tilename == "chat_attachment">
<@tile.print_tile_chat_attachment widget=widget indent=indent />
  <#elseif tilename == "voice_message">
<@tile.print_tile_voice_message widget=widget indent=indent />
  <#elseif tilename == "call_history">
<@tile.print_tile_call_history widget=widget indent=indent />
  <#elseif tilename == "video_call">
<@tile.print_tile_video_call widget=widget indent=indent />
  <#elseif tilename == "contact_merge">
<@tile.print_tile_contact_merge widget=widget indent=indent />
  <#elseif tilename == "address_book_group">
<@tile.print_tile_address_book_group widget=widget indent=indent />
  <#elseif tilename == "favorite_item">
<@tile.print_tile_favorite_item widget=widget indent=indent />
  <#elseif tilename == "saved_search">
<@tile.print_tile_saved_search widget=widget indent=indent />
  <#elseif tilename == "filter_summary">
<@tile.print_tile_filter_summary widget=widget indent=indent />
  <#elseif tilename == "sort_option">
<@tile.print_tile_sort_option widget=widget indent=indent />
  <#elseif tilename == "search_result">
<@tile.print_tile_search_result widget=widget indent=indent />
  <#elseif tilename == "search_suggestion">
<@tile.print_tile_search_suggestion widget=widget indent=indent />
  <#elseif tilename == "empty_state_panel">
<@tile.print_tile_empty_state_panel widget=widget indent=indent />
  <#elseif tilename == "error_state_panel">
<@tile.print_tile_error_state_panel widget=widget indent=indent />
  <#elseif tilename == "maintenance_notice">
<@tile.print_tile_maintenance_notice widget=widget indent=indent />
  <#elseif tilename == "feature_flag">
<@tile.print_tile_feature_flag widget=widget indent=indent />
  <#elseif tilename == "experiment_variant">
<@tile.print_tile_experiment_variant widget=widget indent=indent />
  <#elseif tilename == "ab_test_result">
<@tile.print_tile_ab_test_result widget=widget indent=indent />
  <#elseif tilename == "analytics_event">
<@tile.print_tile_analytics_event widget=widget indent=indent />
  <#elseif tilename == "funnel_step">
<@tile.print_tile_funnel_step widget=widget indent=indent />
  <#elseif tilename == "conversion_metric">
<@tile.print_tile_conversion_metric widget=widget indent=indent />
  <#elseif tilename == "chart_summary">
<@tile.print_tile_chart_summary widget=widget indent=indent />
  <#elseif tilename == "report_header">
<@tile.print_tile_report_header widget=widget indent=indent />
  <#elseif tilename == "report_row">
<@tile.print_tile_report_row widget=widget indent=indent />
  <#elseif tilename == "data_source">
<@tile.print_tile_data_source widget=widget indent=indent />
  <#elseif tilename == "dataset_card">
<@tile.print_tile_dataset_card widget=widget indent=indent />
  <#elseif tilename == "query_history">
<@tile.print_tile_query_history widget=widget indent=indent />
  <#elseif tilename == "export_job">
<@tile.print_tile_export_job widget=widget indent=indent />
  <#elseif tilename == "import_job">
<@tile.print_tile_import_job widget=widget indent=indent />
  <#elseif tilename == "sync_status">
<@tile.print_tile_sync_status widget=widget indent=indent />
  <#elseif tilename == "backup_snapshot">
<@tile.print_tile_backup_snapshot widget=widget indent=indent />
  <#elseif tilename == "restore_point">
<@tile.print_tile_restore_point widget=widget indent=indent />
  <#elseif tilename == "storage_usage">
<@tile.print_tile_storage_usage widget=widget indent=indent />
  <#elseif tilename == "quota_meter">
<@tile.print_tile_quota_meter widget=widget indent=indent />
  <#elseif tilename == "license_summary">
<@tile.print_tile_license_summary widget=widget indent=indent />
  <#elseif tilename == "subscription_plan">
<@tile.print_tile_subscription_plan widget=widget indent=indent />
  <#elseif tilename == "billing_cycle">
<@tile.print_tile_billing_cycle widget=widget indent=indent />
  <#elseif tilename == "tax_invoice">
<@tile.print_tile_tax_invoice widget=widget indent=indent />
  <#elseif tilename == "refund_case">
<@tile.print_tile_refund_case widget=widget indent=indent />
  <#elseif tilename == "support_ticket">
<@tile.print_tile_support_ticket widget=widget indent=indent />
  <#elseif tilename == "support_agent">
<@tile.print_tile_support_agent widget=widget indent=indent />
  <#elseif tilename == "faq_item">
<@tile.print_tile_faq_item widget=widget indent=indent />
  <#elseif tilename == "knowledge_article">
<@tile.print_tile_knowledge_article widget=widget indent=indent />
  <#elseif tilename == "documentation_section">
<@tile.print_tile_documentation_section widget=widget indent=indent />
  <#elseif tilename == "release_channel">
<@tile.print_tile_release_channel widget=widget indent=indent />
  <#elseif tilename == "roadmap_milestone">
<@tile.print_tile_roadmap_milestone widget=widget indent=indent />
  <#elseif tilename == "feedback_card">
<@tile.print_tile_feedback_card widget=widget indent=indent />
  <#elseif tilename == "survey_question">
<@tile.print_tile_survey_question widget=widget indent=indent />
  <#elseif tilename == "survey_response">
<@tile.print_tile_survey_response widget=widget indent=indent />
  <#elseif tilename == "rating_summary">
<@tile.print_tile_rating_summary widget=widget indent=indent />
  <#elseif tilename == "review_card">
<@tile.print_tile_review_card widget=widget indent=indent />
  <#elseif tilename == "moderation_case">
<@tile.print_tile_moderation_case widget=widget indent=indent />
  <#elseif tilename == "content_flag">
<@tile.print_tile_content_flag widget=widget indent=indent />
  <#elseif tilename == "approval_request">
<@tile.print_tile_approval_request widget=widget indent=indent />
  <#elseif tilename == "approval_step">
<@tile.print_tile_approval_step widget=widget indent=indent />
  <#elseif tilename == "signature_request">
<@tile.print_tile_signature_request widget=widget indent=indent />
  <#elseif tilename == "document_version">
<@tile.print_tile_document_version widget=widget indent=indent />
  <#elseif tilename == "document_collaborator">
<@tile.print_tile_document_collaborator widget=widget indent=indent />
  <#elseif tilename == "folder_item">
<@tile.print_tile_folder_item widget=widget indent=indent />
  <#elseif tilename == "permission_rule">
<@tile.print_tile_permission_rule widget=widget indent=indent />
  <#elseif tilename == "role_assignment">
<@tile.print_tile_role_assignment widget=widget indent=indent />
  <#elseif tilename == "audit_event_detail">
<@tile.print_tile_audit_event_detail widget=widget indent=indent />
  <#elseif tilename == "incident_summary">
<@tile.print_tile_incident_summary widget=widget indent=indent />
  <#elseif tilename == "incident_timeline">
<@tile.print_tile_incident_timeline widget=widget indent=indent />
  <#elseif tilename == "on_call_shift">
<@tile.print_tile_on_call_shift widget=widget indent=indent />
  <#elseif tilename == "escalation_rule">
<@tile.print_tile_escalation_rule widget=widget indent=indent />
  <#elseif tilename == "runbook_step">
<@tile.print_tile_runbook_step widget=widget indent=indent />
  <#elseif tilename == "monitor_check">
<@tile.print_tile_monitor_check widget=widget indent=indent />
  <#elseif tilename == "alert_group">
<@tile.print_tile_alert_group widget=widget indent=indent />
  <#elseif tilename == "log_entry">
<@tile.print_tile_log_entry widget=widget indent=indent />
  <#elseif tilename == "trace_span">
<@tile.print_tile_trace_span widget=widget indent=indent />
  <#elseif tilename == "request_detail">
<@tile.print_tile_request_detail widget=widget indent=indent />
  <#elseif tilename == "server_card">
<@tile.print_tile_server_card widget=widget indent=indent />
  <#elseif tilename == "container_card">
<@tile.print_tile_container_card widget=widget indent=indent />
  <#elseif tilename == "cloud_region">
<@tile.print_tile_cloud_region widget=widget indent=indent />
  <#elseif tilename == "integration_card">
<@tile.print_tile_integration_card widget=widget indent=indent />
  <#elseif tilename == "webhook_event">
<@tile.print_tile_webhook_event widget=widget indent=indent />
  <#elseif tilename == "automation_rule">
<@tile.print_tile_automation_rule widget=widget indent=indent />
  <#elseif tilename == "workflow_run">
<@tile.print_tile_workflow_run widget=widget indent=indent />
  <#elseif tilename == "queue_item">
<@tile.print_tile_queue_item widget=widget indent=indent />
  <#elseif tilename == "job_detail">
<@tile.print_tile_job_detail widget=widget indent=indent />
  <#elseif tilename == "schedule_rule">
<@tile.print_tile_schedule_rule widget=widget indent=indent />
  <#elseif tilename == "recurring_task">
<@tile.print_tile_recurring_task widget=widget indent=indent />
  <#elseif tilename == "approval_inbox">
<@tile.print_tile_approval_inbox widget=widget indent=indent />
  <#elseif tilename == "draft_item">
<@tile.print_tile_draft_item widget=widget indent=indent />
  <#elseif tilename == "publish_item">
<@tile.print_tile_publish_item widget=widget indent=indent />
  <#elseif tilename == "campaign_card">
<@tile.print_tile_campaign_card widget=widget indent=indent />
  <#elseif tilename == "audience_segment">
<@tile.print_tile_audience_segment widget=widget indent=indent />
  <#elseif tilename == "channel_summary">
<@tile.print_tile_channel_summary widget=widget indent=indent />
  <#elseif tilename == "social_account">
<@tile.print_tile_social_account widget=widget indent=indent />
  <#elseif tilename == "post_scheduler">
<@tile.print_tile_post_scheduler widget=widget indent=indent />
  <#elseif tilename == "content_calendar">
<@tile.print_tile_content_calendar widget=widget indent=indent />
  <#elseif tilename == "brand_asset">
<@tile.print_tile_brand_asset widget=widget indent=indent />
  <#elseif tilename == "theme_preview">
<@tile.print_tile_theme_preview widget=widget indent=indent />
  <#elseif tilename == "component_variant">
<@tile.print_tile_component_variant widget=widget indent=indent />
  <#elseif tilename == "design_token">
<@tile.print_tile_design_token widget=widget indent=indent />
  <#elseif tilename == "ui_pattern">
<@tile.print_tile_ui_pattern widget=widget indent=indent />
  <#elseif tilename == "prototype_screen">
<@tile.print_tile_prototype_screen widget=widget indent=indent />
  <#elseif tilename == "handoff_item">
<@tile.print_tile_handoff_item widget=widget indent=indent />
  <#elseif tilename == "accessibility_check">
<@tile.print_tile_accessibility_check widget=widget indent=indent />
  <#elseif tilename == "translation_item">
<@tile.print_tile_translation_item widget=widget indent=indent />
  <#elseif tilename == "localization_status">
<@tile.print_tile_localization_status widget=widget indent=indent />
  <#elseif tilename == "language_pack">
<@tile.print_tile_language_pack widget=widget indent=indent />
  <#elseif tilename == "release_calendar">
<@tile.print_tile_release_calendar widget=widget indent=indent />
  <#elseif tilename == "change_request">
<@tile.print_tile_change_request widget=widget indent=indent />
  <#elseif tilename == "risk_register">
<@tile.print_tile_risk_register widget=widget indent=indent />
  <#elseif tilename == "dependency_item">
<@tile.print_tile_dependency_item widget=widget indent=indent />
  <#elseif tilename == "decision_log">
<@tile.print_tile_decision_log widget=widget indent=indent />
  <#elseif tilename == "meeting_notes">
<@tile.print_tile_meeting_notes widget=widget indent=indent />
  <#elseif tilename == "action_item">
<@tile.print_tile_action_item widget=widget indent=indent />
  <#elseif tilename == "okr_objective">
<@tile.print_tile_okr_objective widget=widget indent=indent />
  <#elseif tilename == "key_result">
<@tile.print_tile_key_result widget=widget indent=indent />
  <#elseif tilename == "goal_progress">
<@tile.print_tile_goal_progress widget=widget indent=indent />
  <#elseif tilename == "personal_dashboard">
<@tile.print_tile_personal_dashboard widget=widget indent=indent />
  <#elseif tilename == "quick_action">
<@tile.print_tile_quick_action widget=widget indent=indent />
  </#if>
</#macro>