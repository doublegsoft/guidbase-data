<#--
 ...
 ###############################################################################
 -->
<#macro print_js_declare_testdata widget indent> 
...
${""?left_pad(indent)}${js.nameVariable(widget.id!"unknown")}: sdk.host4Image + '/img/default/avatar.png',   
  <#elseif (widget.type!"unknown") == "image">
${""?left_pad(indent)}${js.nameVariable(widget.id!"unknown")}: sdk.host4Image + '/img/default/thumbnail.png',   
