...
${""?left_pad(indent)}    <swiper-item wx:for="{{items${js.nameType(widget.variable)}}}">
...
${""?left_pad(indent)}<view class="mx-3">
  <#list widget.items as item>
${""?left_pad(indent)}  <navigator bindtap="goto${js.nameType(item.url!'todo')}" url="#" class="weui-cell weui-cell_access" role="navigator">
...
${""?left_pad(indent)}        wx:for="{{items${js.nameType(widget.variable)}}}" wx:for-item="item" data-${widget.variable?replace('_', '-')}="{{item}}" >
...
${""?left_pad(indent)}    <li wx:for="${js.nameVariable(widget.variable)}Items" wx:for-index="index" wx:for-item="item" class="timeline-item">
...
${""?left_pad(indent)}<view class="d-flex full-width" style="<#if widget.style??>${widget.style}</#if>">
${""?left_pad(indent)}  <image src="http://localhost:8888/img/placeholder/300x450.png" class="m-auto" style="height: 320px;"></image>
${""?left_pad(indent)}</view>
</#macro>
...
${""?left_pad(indent)}<editable-form fields="{{fields${js.nameType(widget.variable)}}}" data="{{values${js.nameType(widget.variable)}}}" id="form${js.nameType(widget.variable)}"
${""?left_pad(indent)}               bind:onSubmit="doSaveForm${js.nameType(widget.variable)}" labelWidth="150" mode="horizontal" />
</#macro>
...
${""?left_pad(indent)}  }
${""?left_pad(indent)}
${""?left_pad(indent)}  this.form${js.nameType(widget.variable)} = this.selectComponent('#form${js.nameType(widget.variable)}');
${""?left_pad(indent)}  this.form${js.nameType(widget.variable)}.setValues(data);
${""?left_pad(indent)}},
</#macro>

<#macro print_wxml_declare_readonlyform widget indent>
${""?left_pad(indent)}<editable-form fields="{{fields${js.nameType(widget.variable)}}}" values="{{values${js.nameType(widget.variable)}}}"
${""?left_pad(indent)}               id="readonly${js.nameType(widget.variable)}"
...
${""?left_pad(indent)}        <switch checked="{{values${js.nameType(widget.variable)}['${fieldName}'] === true || values${js.nameType(widget.variable)}['${fieldName}'] == 'T'}}" bindchange=""/>
${""?left_pad(indent)}      </div>
${""?left_pad(indent)}    </div>
...
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="A" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-star mx-1 font-22 {{values${js.nameType(widget.variable)}['${fieldName}'] >= 'A' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="B" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}          class="fas fa-star mx-1 font-22 {{values${js.nameType(widget.variable)}['${fieldName}'] >= 'B' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="C" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-star mx-1 font-22 {{values${js.nameType(widget.variable)}['${fieldName}'] >= 'C' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="D" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-star mx-1 font-22 {{values${js.nameType(widget.variable)}['${fieldName}'] >= 'D' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="E" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-star mx-1 font-22 {{values${js.nameType(widget.variable)}['${fieldName}'] >= 'E' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}      </div>
${""?left_pad(indent)}    </div>
...
${""?left_pad(indent)}      <strong class="font-16">${field.title!'标题'}</strong>
${""?left_pad(indent)}      <div widget-id="${field.title!'标题'}" class="ml-auto position-relative" style="top: 2px;">
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="A" data-type="[]" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-apple-alt font-24 mx-1 {{tool.contains(values${js.nameType(widget.variable)}['${fieldName}'], 'A') ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="B" data-type="[]" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-baseball-ball font-24 mx-1 {{tool.contains(values${js.nameType(widget.variable)}['${fieldName}'], 'B') ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="C" data-type="[]" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-coffee font-24 mx-1 {{tool.contains(values${js.nameType(widget.variable)}['${fieldName}'], 'C') ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="D" data-type="[]" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-smoking font-24 mx-1 {{tool.contains(values${js.nameType(widget.variable)}['${fieldName}'], 'D') ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="E" data-type="[]" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-bed font-24 mx-1 {{tool.contains(values${js.nameType(widget.variable)}['${fieldName}'], 'E') ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="F" data-type="[]" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-poop font-24 mx-1 {{tool.contains(values${js.nameType(widget.variable)}['${fieldName}'], 'F') ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}      </div>
${""?left_pad(indent)}    </div>
...
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="A" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-sad-cry font-24 mx-1 {{values${js.nameType(widget.variable)}['${fieldName}'] == 'A' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="B" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-frown font-24 mx-1 {{values${js.nameType(widget.variable)}['${fieldName}'] == 'B' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="C" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-meh font-24 mx-1 {{values${js.nameType(widget.variable)}['${fieldName}'] == 'C' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="D" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-smile font-24 mx-1 {{values${js.nameType(widget.variable)}['${fieldName}'] == 'D' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}        <i data-name="${fieldName}" data-value="E" bindtap="onBuild${js.nameType(widget.variable)}"
${""?left_pad(indent)}           class="fas fa-laugh-beam font-24 mx-1 {{values${js.nameType(widget.variable)}['${fieldName}'] == 'E' ? 'text-warning-light' : 'text-light'}}"></i>
${""?left_pad(indent)}      </div>
${""?left_pad(indent)}    </div>
    </#if>
${""?left_pad(indent)}  </li>
...
${""?left_pad(indent)}  let list = this.selectComponent(".list${js.nameType(widget.variable)}");
